            ...
            "environment": {
                ...
                "sim": {
                    ...
                    "collision_radius": {
                        "value": 0.08,
                        "type": "float",
                        "desc": "Per-unit-size body radius; min separation = radius x (sizes summed)",
                        "min": 0.01,
                        "max": 0.5,
                    },
                    "speed_size_exponent": {
                        "value": 1.0,
                        "type": "float",
                        "desc": "How strongly size slows movement (0 = size-independent speed)",
                        "min": 0,
                        "max": 3,
                    },
                },
                ...
                "resources": {
                    "initial_energy": {
                        "value": 1.0,
                        "type": "float",
                        "desc": "Energy at spawn (must be <= max energy)",
                        "min": 0.01,
                        "max": 10,
                    },
                    "max_energy": {
                        "value": 1.0,
                        "type": "float",
                        "desc": "Energy cap; food refills up to this",
                        "min": 0.01,
                        "max": 10,
                    },
                    "movement_cost": {
                        "value": 0.01,
                        "type": "float",
                        "desc": "Energy drained per unit of movement",
                        "min": 0.0001,
                        "max": 1,
                    },
                    "attack_cost": {
                        "value": 0.04,
                        "type": "float",
                        "desc": "Energy spent per attack (attack fails if unaffordable)",
                        "min": 0.0001,
                        "max": 1,
                    },
                    "food_count": {
                        "value": 2,
                        "type": "int",
                        "desc": "Simultaneous food pellets in the arena",
                        "min": 0,
                        "max": 20,
                    },
                    "food_energy": {
                        "value": 0.35,
                        "type": "float",
                        "desc": "Energy restored per pellet eaten",
                        "min": 0.01,
                        "max": 10,
                    },
                    "food_radius": {
                        "value": 0.10,
                        "type": "float",
                        "desc": "Pickup distance for a food pellet",
                        "min": 0.01,
                        "max": 1,
                    },
                    "food_respawn_steps": {
